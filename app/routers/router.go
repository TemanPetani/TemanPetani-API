...
func initUserRouter(db *gorm.DB, e *echo.Echo) {
	...
	e.PUT("/users/picture", userHandler.UpdateUserPicture, middlewares.JWTMiddleware())
...
func initPlantsRouter(db *gorm.DB, e *echo.Echo) {
	...
	e.DELETE("/plants/:id", plantHandler.DeleteScheduleById, middlewares.JWTMiddleware())
}
